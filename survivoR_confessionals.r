...
#assign R variables
rdataname <- "confessionals"

# COMMAND ----------

# MAGIC %sh
# MAGIC advantage_details_variable="confessionals"
...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TABLE bronze_confessionals
# MAGIC AS
# MAGIC SELECT *
# MAGIC FROM tmp_confessionals;
# MAGIC
# MAGIC CREATE OR REPLACE TABLE gold_confessionals
# MAGIC AS
# MAGIC SELECT *
# MAGIC FROM bronze_confessionals
