...
# MAGIC %sh
# MAGIC advantage_details_variable="castaways"
...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TABLE bronze_castaways
# MAGIC AS
# MAGIC SELECT *
# MAGIC FROM tmp_castaways;
# MAGIC
# MAGIC CREATE OR REPLACE TABLE gold_castaways
# MAGIC AS
# MAGIC SELECT *
# MAGIC FROM bronze_castaways
