...
#assign R variables
rdataname <- "vote_history"

# COMMAND ----------

# MAGIC %sh
# MAGIC advantage_details_variable="vote_history"
...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE TABLE bronze_vote_history
# MAGIC AS
# MAGIC SELECT *
# MAGIC FROM tmp_vote_history;
# MAGIC
# MAGIC CREATE OR REPLACE TABLE gold_vote_history
# MAGIC AS
# MAGIC SELECT *
# MAGIC FROM bronze_vote_history
